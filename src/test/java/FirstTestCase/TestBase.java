...
public class TestBase {
    ...
    public void setUp() {
        ...
        capabilities.setCapability("videoName", "Katso(EKB)TestCaseForFirstSendOrder.mp4");
        capabilities.setCapability("name", "Katso(EKB)TestCaseForFirstSendOrder");
